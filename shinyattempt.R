...
ui <- navbarPage("Iowa Liquor Sales",
                 tabPanel("Locations of Liquor Stores",
                          fluidRow(
                            sidebarPanel(selectInput(inputId = "City",
                                          label = "Cities in Story County",
                                          choices = c("Ames", "Cambridge", "Collins", "Colo", "Gilbert", "Huxley", "Kelley", "Maxwell", "McCallsburg", "Nevada", "Roland", "Shedahl", "Slater", "Story City", "Zearing"))
                            ),
                            mainPanel(
                 ...
                 tabPanel("Liquor Sales by Grocery Store")
)
